...
public interface ConfigConstants {
     ...
     * 是否开启自定义隔离规则
     */
    String CONFIG_RIBBON_ISOLATION_ENABLED = "peak.ribbon.isolation.enabled";

    String CONFIG_LOADBALANCE_ISOLATION = "peak.loadbalance.isolation";
    ...
    String CONFIG_LOADBALANCE_VERSION = "peak.loadbalance.version";
